...
var _user$project$Login$updateStats = F2(
	function ($int, stats) {
		var _p0 = $int;
		switch (_p0) {
			case 1:
			...
			default:
				...
				return (username && password) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						username: '',
						password: '',
						stats: A2(_user$project$Login$updateStats, 1, model.stats)
					}) : _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						username: '',
						password: '',
						stats: A2(_user$project$Login$updateStats, 0, model.stats)
					});
		}
	});
var _user$project$Login$initModel = {
	username: '',
	password: '',
	loggedIn: {ctor: '_Tuple2', _0: false, _1: 'Please insert your credentials'},
	stats: {success: 0, failed: 0}
};
var _user$project$Login$Statistics = F2(
	function (a, b) {
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(_user$project$Login$Login),
		...
		switch (_p0.ctor) {
			...
			default:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						users: A2(_user$project$Users$update, _p0._0, model.users)
					});
		}
	});
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {page: a, login: b, users: c};
	});
var _user$project$Main$UsersPage = {ctor: 'UsersPage'};
var _user$project$Main$LoginPage = {ctor: 'LoginPage'};
var _user$project$Main$initModel = {page: _user$project$Main$LoginPage, login: _user$project$Login$initModel, users: _user$project$Users$initModel};
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('#'),
								_elm_lang$html$Html_Events$onClick(
								_user$project$Main$ChangePage(_user$project$Main$UsersPage))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Users')
