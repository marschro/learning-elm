...
var _user$project$Main$updateStats = F2(
	function ($int, stats) {
		var _p0 = $int;
		switch (_p0) {
			case 1:
			...
			default:
				...
				return (username && password) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						username: '',
						password: '',
						stats: A2(_user$project$Main$updateStats, 1, model.stats)
					}) : _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						username: '',
						password: '',
						stats: A2(_user$project$Main$updateStats, 0, model.stats)
					});
		}
	});
...
var _user$project$Main$Statistics = F2(
	function (a, b) {
...
var _user$project$Main$PasswordInput = function (a) {
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onInput(_user$project$Main$UsernameInput)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onInput(_user$project$Main$PasswordInput)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onSubmit(_user$project$Main$Login)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
