...
var _user$project$State$Model = F2(
	function (a, b) {
		return {menuIsVisible: a, menuStyle: b};
	});
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'ToggleMenu') {
			...
			var menuStyle = A2(
				...
				{
					ctor: '::',
					_0: _mdgriffith$elm_style_animation$Animation$to(toggleStyle),
					_1: {ctor: '[]'}
				},
				model.menuStyle);
			return {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						menuStyle: A2(_mdgriffith$elm_style_animation$Animation$update, _p0._0, model.menuStyle)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
...
var _user$project$Update$initModel = {
	menuIsVisible: false,
	menuStyle: _mdgriffith$elm_style_animation$Animation$style(
		{
			ctor: '::',
			_0: _mdgriffith$elm_style_animation$Animation$left(
				_mdgriffith$elm_style_animation$Animation$px(-40)),
				...
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value('Menu'),
								_1: {ctor: '[]'}
							}
						}
					}
