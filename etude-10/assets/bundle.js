			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$value('Delete'),
		...
		switch (_p1.ctor) {
			...
			case 'AddNewUser':
				if (_elm_lang$core$String$isEmpty(model.name)) {
					...
					var newUserList = A2(_elm_lang$core$List_ops['::'], newUser, model.users);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onInput(_user$project$Main$InsertName),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('text'),
								_elm_lang$html$Html_Events$onInput(_user$project$Main$InsertAge),
								_elm_lang$html$Html_Attributes$placeholder('Age'),
								_elm_lang$html$Html_Attributes$value(model.age)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('button'),
								_elm_lang$html$Html_Events$onClick(_user$project$Main$InitNewUser),
								_elm_lang$html$Html_Attributes$value('Add new user')
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
				...
				_user$project$Main$userListView(model),
				A2(
